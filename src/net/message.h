 ...
 */
    ...
    //#define BULK_MSG_ID 1 // 开启此宏则会使用无论如何都不可能重复的id机制，但是header占比更大。
...
PUBLIC
    ...
    static common::Buffer* GetNewBuffer(sys::MemPoolObject *mpo, uint32_t totalBufferSize);
