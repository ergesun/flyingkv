...
public:
     ...
     */
    ANetStackMessageWorker(AFileEventHandler *eventHandler, sys::MemPool *memPool,
...
protected:
    ...
    static RcvMessage* getNewRcvMessage(sys::MemPool *mp, net_peer_info_t peerInfo, Message::Header h,
