...
ANetStackMessageWorker::ANetStackMessageWorker(AFileEventHandler *eventHandler, sys::MemPool *memPool,
...
RcvMessage* ANetStackMessageWorker::getNewRcvMessage(sys::MemPool *mp, net_peer_info_t peerInfo,
