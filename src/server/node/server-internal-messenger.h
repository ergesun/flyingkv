...
#ifndef MINIKV_NODE_INTERNAL_MESSENGER_H
#define MINIKV_NODE_INTERNAL_MESSENGER_H
...
private:
    ...
    sys::ThreadPool<std::shared_ptr<net::NotifyMessage>>                                *m_pDispatchTp        = nullptr;
    ...
    sys::spin_lock_t                                                                     m_slMsgMapper        = UNLOCKED;
};
} // namespace server
} // namespace minikv

#endif //MINIKV_NODE_INTERNAL_MESSENGER_H
