...
DEFINE_uint32(wal_max_segment_size, 1024 * 1024 * 100, "log-clean wal max segment file size");
DEFINE_uint32(wal_batch_read_size, 1024 * 1024 * 10, "log-clean wal batch read buffer size");
...
DEFINE_uint32(cp_batch_read_size, 1024 * 1024 * 10, "checkpoint batch read buffer size");
