...
DEFINE_uint32(kv_do_checkpoint_wal_size, 200, "触发做checkpoint的wal大小阈值:bytes");
...
DEFINE_uint32(wal_max_segment_size, 1024 * 1024 * 50, "log-clean wal max segment file size:bytes");
DEFINE_uint32(wal_batch_read_size, 1024 * 1024 * 4, "log-clean wal batch read buffer size:bytes");
...
DEFINE_uint32(cp_batch_read_size, 1024 * 1024 * 4, "checkpoint batch read buffer size:bytes");
