 ...
 * glog配置
 */
DEFINE_string(glog_dir, "/tmp/minikv/logs", "glog的保存路径");
...
DEFINE_string(data_dir, "/tmp/minikv", "数据存放目录。");
...
DEFINE_string(servers_conf_path, "/tmp/minikv/conf/servers", "集群server地址信息。");
